...
!function(e) {
    ...
    e.fn.poptrox = function(o) {
        ...
        var i, s, r = e.extend({
            ...
            onPopupClose: null,
            onPopupOpen: null
        }, o), n = e(this), a = e("body"), l = e('<div class="' + r.overlayClass + '"></div>'), u = e(window), d = [], h = 0, g = !1, f = new Array;
        ...
        r.usePopupNav || (r.popupNavPreviousSelector = null,
        ...
        var v = x.find(".pic")
          ...
          , P = y.add(S);
        if (r.usePopupDefaultStyling && (x.css("background", r.popupBackgroundColor).css("color", r.popupTextColor).css("padding", r.popupPadding + "px"),
        m.length > 0 && (x.css("padding-bottom", r.popupCaptionHeight + "px"),
        m.css("position", "absolute").css("left", "0").css("bottom", "0").css("width", "100%").css("text-align", "center").css("height", r.popupCaptionHeight + "px").css("line-height", r.popupCaptionHeight + "px"),
        ...
        b.length > 0 && b.html("").css("position", "relative").css("font-size", r.popupLoaderTextSize).on("startSpinning", function(o) {
        ...
        m.on("update", function(e, o) {
            o && 0 != o.length || (o = r.popupBlankCaptionText),
            m.html(o)
        }),
        ...
        x.css("display", "inline-block").css("vertical-align", "middle").css("position", "relative").css("z-index", 1).css("cursor", "auto").appendTo(l).hide().on("poptrox_next", function() {
            ...
            "ajax" == s.type ? e.get(s.src, function(e) {
                w.html(e),
                w.trigger("load")
            }) : w.attr("src", s.src),
            "image" != s.type) {
                ...
                w.css("position", "relative").css("outline", "0").css("z-index", r.baseZIndex + 100).width(n).height(a)
            }
            b.trigger("startSpinning").fadeIn(300),
            x.show(),
            r.popupIsFixed ? (x.removeClass("loading").width(r.popupWidth).height(r.popupHeight),
            w.load(function() {
                w.off("load"),
                b.hide().trigger("stopSpinning"),
                m.trigger("update", [s.captionText]).fadeIn(r.fadeSpeed),
                C.fadeIn(r.fadeSpeed),
                v.css("text-indent", 0).hide().fadeIn(r.fadeSpeed, function() {
                    g = !1
                }),
                h = p,
                d.length > 1 && P.fadeIn(r.fadeSpeed)
            })) : w.load(function() {
                t(),
                w.off("load"),
                b.hide().trigger("stopSpinning");
                ...
                e == x.data("width") && o == x.data("height") ? i() : x.animate({
                    width: e,
                    height: o
                }, r.popupSpeed, "swing", i)
            }),
            "image" != s.type && w.trigger("load")
        }).on("poptrox_close", function() {
            return g && !r.usePopupForceClose ? !0 : (g = !0,
            x.hide().trigger("poptrox_reset"),
            r.onPopupClose && r.onPopupClose(),
            void l.fadeOut(r.fadeSpeed, function() {
                r.useBodyOverflow && a.css("overflow", "auto"),
                g = !1
            }))
        }).trigger("poptrox_reset"),
        r.usePopupEasyClose ? (m.on("click", "a", function(e) {
            e.stopPropagation()
        }),
        ...
        n.find(r.selector).each(function(o) {
            var t, p, i = e(this), s = i.find("img"), n = i.data("poptrox");
            if ("ignore" != n && i.attr("href")) {
                ...
                r.caption) {
                    if ("function" == typeof r.caption)
                        ...
                        "attribute"in r.caption ? c = a.attr(r.caption.attribute) : (c = a.html(),
                        r.caption.remove === !0 && a.remove())
                    }
                } else
                    c = s.attr("title");
                if (t.captionText = c,
